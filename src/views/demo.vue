<template>
  <div class="page-container">
    ...
    <p>
      丁俊宏設定三年內在亞太地區互動遊戲廣告市場闖出一片天，他對自家的技術相當有信心，現階段目標是讓VMFive把市場做大、做好，並希望這家公司可以永續經營。
    </p>
    <hr />
    <p>
      文章來源：
...
import { custom_container, custom_tetris, anime_timeline, custom_video, custom_backgroundImage } from "../module.js";
// import "../js/MixPlayer";
    ...
    async dothing(demoLay, demoOp) {
      ...
      function getCustomJs(type) {
        let layouts = {
          ...
          expand: function() {
            custom_backgroundImage(unitContainer, demoOp);
            custom_video(unitContainer, demoOp);
          },
          // default 怎麼寫？？？
          default: function() {
          }
